...
// Main Application Pages - Lazy loaded to prevent issues
const EnhancedDashboard = React.lazy(() => import("@/components/propguard/EnhancedDashboard").catch(() => ({ default: () => <div>Dashboard loading...</div> })));
